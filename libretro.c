...
#undef PGXP_STACK_OPTION
...

   {
      ...
      if (environ_cb(RETRO_ENVIRONMENT_GET_VARIABLE, &var) && var.value)
      {
         ...
         else if (strcmp(var.value, "coverage preserve cap8") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8;
         else if (strcmp(var.value, "coverage preserve cap12") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP12;
         else if (strcmp(var.value, "coverage preserve cap14") == 0)
         ...
         else if (strcmp(var.value, "coverage preserve cap8 opaque") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8_OPAQUE;
         else if (strcmp(var.value, "coverage preserve cap8 semitrans") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8_SEMITRANS;
         else if (strcmp(var.value,
                  "coverage preserve cap8 opaque semi one") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8_OPAQUE_SEMI_ONE;
         else if (strcmp(var.value,
                  "coverage preserve cap8 opaque skirt marker") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8_OPAQUE_SKIRT_MARKER;
         else if (strcmp(var.value,
                  "coverage preserve cap8 opaque one") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8_OPAQUE_ONE;
         else if (strcmp(var.value,
                  "coverage preserve cap8 opaque two") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8_OPAQUE_TWO;
         else if (strcmp(var.value,
                  "coverage preserve cap8 opaque three") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_COVERAGE_PRESERVE_CAP8_OPAQUE_THREE;
         else if (strcmp(var.value,
                  "coverage preserve cap4 opaque four") == 0)
            gl_test_mode =
         ...
         else if (strcmp(var.value, "partial long any four") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_PARTIAL_LONG_ANY_FOUR;
         else if (strcmp(var.value, "partial both gap four") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_PARTIAL_BOTH_GAP_FOUR;
         else if (strcmp(var.value, "partial long gap four") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_PARTIAL_LONG_GAP_FOUR;
         else if (strcmp(var.value, "partial both overlap four") == 0)
            gl_test_mode =
               PGXP_DIAG_GL_TEST_PARTIAL_BOTH_OVERLAP_FOUR;
         else if (strcmp(var.value, "partial both gap fit") == 0)
            gl_test_mode =
         ...
         else if (strcmp(var.value, "native union x all") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_NATIVE_UNION_X_ALL;
         else if (strcmp(var.value, "native union y all") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_NATIVE_UNION_Y_ALL;
         else if (strcmp(var.value, "native union y delta one") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_NATIVE_UNION_Y_DELTA_ONE;
         else if (strcmp(var.value, "native union y delta two") == 0)
            gl_test_mode = PGXP_DIAG_GL_TEST_NATIVE_UNION_Y_DELTA_TWO;
         else if (strcmp(var.value, "native union y tail two") == 0)
