...
/* Exercise the production platform rename implementation rather than a test
 * double which merely assumes the same replacement contract. */
#include "rename_under_test.h"
