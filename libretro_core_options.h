...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      NULL,
      "Focused GL/Vulkan PGXP coverage diagnostic. Mode 156 renders opaque textured fragments magenta before transparency discard. Vulkan modes 161-162 keep every primitive in its normal queue, shader family, render pass, mask, depth and scissor state while probing all primitive classes. In mode 162: magenta=opaque textured, cyan=semi-transparent textured, yellow=opaque flat, green=semi-transparent flat.",
      NULL,
      "pgxp",
      {
         ...
         { "native ot all",         "23: Native XY - All Opaque Textured (Control)" },
         { "native ot flat tri",    "24: Native XY - Flat Triangles" },
         { "native ot flat quad",   "25: Native XY - Flat Quads" },
         { "native ot gouraud tri", "26: Native XY - Gouraud Triangles" },
         { "native ot gouraud quad", "27: Native XY - Gouraud Quads" },
         { "native ot x",           "28: Native X Only - All Opaque Textured" },
         { "native ot y",           "29: Native Y Only - All Opaque Textured" },
         { "native ot delta small", "30: Native XY - Triangle Delta <= 0.5px" },
         { "native ot delta large", "31: Native XY - Triangle Delta > 0.5px" },
         { "native ot valid w",     "32: Native XY - Valid W" },
         { "native ot invalid w",   "33: Native XY - Invalid W" },
         { "vulkan clip math",      "34: Exact Vulkan Clip-Math Order" },
         { "ot y blend 50",         "35: Opaque Textured Y - 50% Toward Native" },
         { "ot y blend 75",         "36: Opaque Textured Y - 75% Toward Native" },
         { "ot y blend 875",        "37: Opaque Textured Y - 87.5% Toward Native" },
         { "ot y gt half",          "38: Native Y Per Vertex - |dY| > 0.5px" },
         { "ot y gt quarter",       "39: Native Y Per Vertex - |dY| > 0.25px" },
         { "ot y le half",          "40: Native Y Per Vertex - |dY| <= 0.5px" },
         { "ot y native x blend 25", "41: Native Y + X 25% Toward Native" },
         ...
         { "texture solid opaque", "50: Solid Opaque Textured (Coverage Test)" },
         { "texture transparent marker", "51: Mark Transparent Opaque Texels" },
         { "coverage expand three", "52: GL Coverage Expand - 3 Subpixels (Cap 8x)" },
         { "coverage expand four", "53: GL Coverage Expand - 4 Subpixels (Cap 8x)" },
         ...
         { "coverage valid w five", "60: GL Coverage Expand - 5 Subpixels (Valid PGXP W)" },
         ...
         { "coverage preserve cap8", "70: GL Coverage + Preserve Surface (Cap 8x)" },
         ...
         { "adjacency material one", "89: GL Shared Edge - Same Material, 1 Subpixel" },
         { "adjacency material two", "90: GL Shared Edge - Same Material, 2 Subpixels" },
         { "adjacency material four", "91: GL Shared Edge - Same Material, 4 Subpixels" },
         { "adjacency any four", "92: GL Shared Edge - Any Material, 4 Subpixels" },
         { "adjacency near four", "93: GL Shared Edge - Same Material + Near Packet, 4 Subpixels" },
         { "adjacency uv four", "94: GL Shared Edge - Same Material + Matching UV, 4 Subpixels" },
         { "partial short material four", "95: GL Partial Edge - Short Only, Same Material, 4 Subpixels" },
         { "partial short any four", "96: GL Partial Edge - Short Only, Any Material, 4 Subpixels" },
         { "partial both material four", "97: GL Partial Edge - Both, Same Material, 4 Subpixels" },
         { "partial both any four", "98: GL Partial Edge - Both, Any Material, 4 Subpixels" },
         { "overlap both any four", "99: GL Any Collinear Overlap - Both, Any Material, 4 Subpixels" },
         { "partial long any four", "100: GL Partial Edge - Long Only, Any Material, 4 Subpixels" },
         { "partial both gap four", "101: GL Partial True Gap - Both, 4 Subpixels" },
         { "partial long gap four", "102: GL Partial True Gap - Long Only, 4 Subpixels" },
         ...
         { "partial both overlap one", "111: GL Partial Existing Overlap - Both, 1 Subpixel" },
         { "partial both overlap two", "112: GL Partial Existing Overlap - Both, 2 Subpixels" },
         { "partial both overlap three", "113: GL Partial Existing Overlap - Both, 3 Subpixels" },
         { "partial both any one", "114: GL Partial Any Topology - Both, 1 Subpixel" },
         { "partial both any two", "115: GL Partial Any Topology - Both, 2 Subpixels" },
         { "partial both any three", "116: GL Partial Any Topology - Both, 3 Subpixels" },
         { "parallel gap fit quarter", "117: GL Parallel Gap Fit - Native Distance <= 0.25px" },
         { "parallel gap fit half", "118: GL Parallel Gap Fit - Native Distance <= 0.5px" },
         ...
         { "native union y flat only", "149: Clamp-1 Repair - Flat Shading Only" },
         { "native union y gouraud only", "150: Clamp-1 Repair - Gouraud Shading Only" },
         { "native union y raw only", "151: Clamp-1 Repair - Raw Texture Only" },
         { "native union y modulated only", "152: Clamp-1 Repair - Modulated Texture Only" },
