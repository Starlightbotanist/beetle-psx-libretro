...
struct retro_core_option_v2_definition option_defs_us[] = {
...
#if PGXP_DIAG && (defined(HAVE_OPENGL) || defined(HAVE_OPENGLES))
   {
      ...
      NULL,
      "Diagnostic-build-only runtime experiments for OpenGL/OpenGLES PGXP seams. Modes 1-14 are the completed geometry-repair matrix; 15-22 are the completed raster-convention matrix. Modes 23-33 reproduce the native-XY positive control only at the final opaque-textured handoff, then partition it by shading, primitive type, axis, displacement, and W validity.",
      NULL,
      "pgxp",
      {
