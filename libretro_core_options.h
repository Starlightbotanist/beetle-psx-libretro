...
struct retro_core_option_v2_definition option_defs_us[] = {
...
#if defined(HAVE_VULKAN)
   {
      ...
      NULL,
      "Precompile the complete set of Vulkan graphics pipelines required by the current configuration. This prevents first-use shader compilation stalls at the cost of a longer initial startup. The persistent driver cache makes later starts substantially faster.",
      NULL,
      "video",
      {
         { "disabled", NULL },
